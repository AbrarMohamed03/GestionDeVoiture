                        ...
                        <div class="w-full max-w-xs m-10">
                            @foreach ($Voitures as $Voiture)
                                <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" method="post"
                                    enctype="multipart/form-data" action="{{ route('savevoiture') }}"
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <input
                                            ...
                                            type="number" name="kilométrage" value="{{ $Voiture->kilométrage }}">
                                    </div>
                                    <div class="mb-6">
                                        <label class="block text-gray-700 text-sm font-bold mb-2" for="fabriquant">
                                            Modele
                                        ...
                                        <select id="underline_select" name="modele_id"
                                            ...
                                            @foreach ($Modeles as $Modele)
                                                <option value="{{ $Modele->id }}"
                                                    @if ($Modele->id == $Voiture->$modele_id) selected @endif>
